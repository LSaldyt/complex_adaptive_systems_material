...
%% This project centers around the progression of mathematical models of neural memory, which largely started with the recognition of sparse distributed memory (P Kanerva - 1988),  Advanced methods in neural computing
%% PD Wasserman, and now is matched by modern [Search].
